$(document).ready(function(){
    ...
    //***********************
    //**评论的代码也删掉哦***
    window.disqus_shortname = 'linchaohuiblog'; // required: replace example with your forum shortname
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('linchaohui.cn')>-1 ){
	 ...
	 (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
	  ...
	  ga('create', 'UA-50303002-1', 'linchaohui.cn');
	  ga('send', 'pageview');
